...
C {../schematics/switch.sym} 460 -390 0 0 {name=X4 W_U=12 L_U=0.5}
C {../schematics/switch.sym} 820 -540 2 0 {name=X8 W_U=12 L_U=0.5}
C {../schematics/switch.sym} 820 -390 2 0 {name=X9 W_U=12 L_U=0.5}
