...
C {devices/lab_pin.sym} 130 -30 0 0 {name=p2 sig_type=std_logic lab=PRE_n}
C {devices/lab_pin.sym} 190 -30 2 0 {name=p1 sig_type=std_logic lab=PRE_p}
C {devices/ipin.sym} 0 -30 1 0 {name=p3 lab=SH_p}
C {devices/ipin.sym} 0 30 3 0 {name=p4 lab=SH_n}
C {devices/lab_pin.sym} 480 -90 0 0 {name=p9 sig_type=std_logic lab=D_n}
C {devices/lab_pin.sym} 640 -90 2 0 {name=p11 sig_type=std_logic lab=D_p}
...
C {devices/ipin.sym} -350 -120 0 1 {name=p6 lab=RCLN_p}
C {devices/ipin.sym} -350 30 0 1 {name=p15 lab=STON_p}
C {devices/ipin.sym} -410 -120 2 1 {name=p21 lab=RCLN_n}
C {devices/ipin.sym} -410 30 2 1 {name=p22 lab=STON_n}
