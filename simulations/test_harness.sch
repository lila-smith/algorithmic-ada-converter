...
value="pwl(0 0 35ns 0 37ns 1.8 55ns 1.8 57ns 0)"}
...
value=1}
C {madvlsi/vsource.sym} 520 -60 0 0 {name=Vrst
value="pwl(0n 1.8 9n 1.8 10n 0)"}
C {madvlsi/gnd.sym} 250 -30 0 0 {name=l1 lab=GND}
C {madvlsi/gnd.sym} 340 -30 0 0 {name=l2 lab=GND}
C {madvlsi/gnd.sym} 520 -30 0 0 {name=l4 lab=GND}
...
C {devices/lab_pin.sym} 520 -90 0 0 {name=p7 sig_type=std_logic lab=RST}
...
value="pulse(0 1.8 1n 1n 1n 4n 20n)"}
...
C {devices/code.sym} 100 -370 0 0 {name=SPICE only_toplevel=false value=".tran 0.01n 100n
.save all"}
